  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans">
      <div className="w-56 bg-white border-r p-5">
        <h2 className="text-xl font-bold text-blue-600 mb-8">CarePlus</h2>
        <ul className="space-y-3 font-medium text-slate-600">
          <li className="bg-blue-600 text-white p-2.5 rounded-lg cursor-pointer">Dashboard</li>
          <li className="p-2.5 cursor-pointer">Appointments</li>
          <li className="p-2.5 cursor-pointer">Patients</li>
          <li className="p-2.5 cursor-pointer">Profile</li>
          <li className="p-2.5 mt-10 cursor-pointer">Logout</li>
        </ul>
      </div>

      <div className="flex-1 p-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-slate-800">Welcome back, Dr. Ahmed! 👋</h1>
          <div className="text-right">
            <p className="font-bold text-slate-800">Dr. Ahmed</p>
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-4 rounded-xl border text-center">
            ...
            <h3 className="text-2xl font-bold text-blue-600 mt-2">{appointments.length}</h3>
          </div>
          <div className="bg-white p-4 rounded-xl border text-center">
          ...
          <div className="bg-white p-4 rounded-xl border text-center">
            ...
            <h3 className="text-2xl font-bold text-emerald-600 mt-2">{confirmedCount}</h3>
          </div>
          <div className="bg-white p-4 rounded-xl border text-center">
            <p className="text-sm text-slate-500">Cancelled</p>
            <h3 className="text-2xl font-bold text-red-500 mt-2">{cancelledCount}</h3>
          </div>
        </div>
            ...
            <tbody className="divide-y text-sm text-slate-700">
              {appointments.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="p-3 font-semibold text-slate-900">{item.patientName || item.patient}</td>
